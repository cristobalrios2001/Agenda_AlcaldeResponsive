        ...
        <div class="modal-body">
         <div class="row">
            ...
            <div class="col-4">
                ...
                <input id="" type="date" name="frmactividad" class="form-control" value="{{$fecha->fecha}}" required>
            </div>
            <div class="col-md-12">
...
<script>
    var horas; // Variable global para almacenar las horas
        ...
        inputFecha.addEventListener('change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // Lanza un evento personalizado después de asignar las horas
...
<script>
  ...
  <script>
    var horasOcupadas = @json($horasOcupadas);
    // console.log('Horas Ocupadas:');
    // console.log(horasOcupadas);

    function transformarFormatoHora(hora) {
        return hora + ":00";
    }

    for (var i = 0; i < horasOcupadas.length; i++) {
        horasOcupadas[i] = transformarFormatoHora(horasOcupadas[i]);
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        for (var i = 0; i < selectHora.options.length; i++) {
            ...
            // Verificar si la hora está ocupada y ocultar la opción correspondiente
            if (horasOcupadas.includes(optionValue)) {
                selectHora.options[i].style.display = 'none';
            }
        }
    });
</script>
